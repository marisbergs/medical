		...
		private XmlSchemaCollection MappingSchemaCollection
		{
			get
			{
				if( mappingSchemaCollection == null )
				{
					...
					mappingSchemaCollection.Add( XmlSchema.Read( (new StreamReader(   MappingSchemaResource)), null ) );
				}
		...
		private XmlSchemaCollection CfgSchemaCollection
		{
			get
			{
				if( cfgSchemaCollection == null )
				{
					...
					cfgSchemaCollection.Add( XmlSchema.Read( (new StreamReader(  CfgSchemaResource )), null ) );
				}
