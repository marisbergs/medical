...
Public Class ClassifierFind
    ...
    Public Overridable Property UseIsPresentCard() As Boolean
        Get
            Return _useIsPresentCard
        End Get
        Set(ByVal value As Boolean)
            Me.Assign("UseIsPresentCard", value, _useIsPresentCard)
        End Set
    End Property

    Public Overridable Property UseIsSubscription() As Boolean
        Get
            Return _useIsSubscription
        End Get
        Set(ByVal value As Boolean)
            Me.Assign("UseIsSubscription", value, _useIsSubscription)
        End Set
    End Property
    ...
    Private _useIsPresentCard As Boolean
    Private _useIsSubscription As Boolean
...
#Region "ISearchObject"
    ...
    Public Function BuildCriteria() As IList(Of Core.Dal.Expressions.CriterionBase) Implements Core.Bll.ISearchObject.BuildCriteria
        ...
        If UseIsPresentCard Then result.Add(New Expressions.Eq("ReferenceSecond.SecondMark", True))
        If UseIsSubscription Then result.Add(New Expressions.Eq("ReferenceSecond.Value", "Abonements"))
