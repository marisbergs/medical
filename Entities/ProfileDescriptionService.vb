...
Public Class ProfileDescriptionService
    ...
    Public Overridable Property ProfileDescription() As ProfileDescription
        Get
            Return _profileDescription
        End Get
        Set(ByVal value As ProfileDescription)
    ...
    Public Property Parent() As Object Implements Core.Dal.IHasParent.Parent
        ...
        Set(ByVal value As Object)
            Me.ProfileDescription = CType(value, ProfileDescription)
        End Set
    End Property
