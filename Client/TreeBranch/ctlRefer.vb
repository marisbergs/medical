...
Public Class ctlRefer
    ...
    Private Sub ctlPrescription_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        list = Entities(Of Prescription).GetAll(parent.Session, New Expressions.In("DocType", DocumentType.RTG, DocumentType.USG), New Expressions.Eq("Patient", parent._patient))
