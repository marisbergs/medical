...
GO
exec sp_addextendedproperty N'MS_Description', N'NIS izziòas LAPK pants', N'user', N'dbo', N'table', N'StatementViolationDetails', N'column', N'SVD_ARTICLE_ID'
GO
ALTER TABLE StatementViolationDetails ADD 
    SVD_EXTERNAL_VIOLATION_ID uniqueidentifier NULL 
    constraint FK_SVD_EXTERNAL_VIOLATION_ID references Classifiers(CLS_ID)
GO
exec sp_addextendedproperty N'MS_Description', N'NIS izziòas pârkâpums', N'user', N'dbo', N'table', N'StatementViolationDetails', N'column', N'SVD_EXTERNAL_VIOLATION_ID'
GO
